...
private[sec] object config:
  ...
  def mkOptions[F[_]: ApplicativeThrow](cfg: Config): F[Options] =
    ...
    val modifications: List[Endo[Options]] = List(
      ...
      o => cfg.durationOpt(s"$rootPath.keep-alive-time").fold(o)(o.withKeepAliveTime),
      o => cfg.durationOpt(s"$rootPath.keep-alive-timeout").fold(o)(o.withKeepAliveTimeout),
      o => cfg.option(s"$rootPath.keep-alive-without-calls", _.getBoolean).fold(o)(o.withKeepAliveWithoutCalls),
