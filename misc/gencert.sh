...
SEC_GENCERT_IMAGE_VERSION="${SEC_GENCERT_IMAGE_VERSION:-1.0.2}"
...
SEC_GENCERT_IP_ADDRESSES="${SEC_GENCERT_IP_ADDRESSES:-127.0.0.1,172.18.0.2,172.20.0.2,172.20.0.3,172.20.0.4}"
